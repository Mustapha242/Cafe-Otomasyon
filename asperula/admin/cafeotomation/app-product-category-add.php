...
<head>
    ...
    <title>Kategori Ekleme | Asperula - Cafe Yonetim Paneli </title>
                    ...
                    <div class="row invoice layout-top-spacing layout-spacing">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="doc-container">
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <form action="app-product-category-add.php" method="POST">
                                                ...
                                                <div class="invoice-detail-body">
                                                    ...
                                                    <div class="invoice-detail-title">
                                                        ...
                                                        <div class="invoice-title">
                                                            <input type="text" class="form-control" name="product_category_name" placeholder="Kategori Adi">
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 align-self-center">
                                                                <div class="form-group row invoice-note mb-4">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <textarea class="form-control" name="product_category_description" id="product_category_description" placeholder='Kategori Aciklamasi' style="height: 88px;"></textarea>
                                                                    </div>
                                                                </div>

                                                                <div class="row ">
                                                                    <div class="col-xl-12 col-md-4">
                                                                        <button type="submit" name="category_add" class="btn btn-primary btn-send">Kategori Ekle</button>
                                                                    </div>
                                                                </div>
