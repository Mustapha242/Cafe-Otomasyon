...
<head>
    ...
    <title><?php echo $fetchDataProductCategoryDetails['product_category_name'] ?> Duzenleme | Asperula - Cafe Yonetim Paneli </title>
                    ...
                    <div class="row invoice layout-top-spacing layout-spacing">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="doc-container">
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <form action="app-product-category-edit.php" method="POST">
                                                ...
                                                <div class="invoice-detail-body">
                                                    ...
                                                    <div class="invoice-detail-title">
                                                        ...
                                                        <div class="invoice-title">
                                                            <input type="text" class="form-control" name="product_category_name" placeholder="Kategori Adi" value="<?php echo $fetchDataProductCategoryDetails['product_category_name'] ?>">
                                                        </div>
                                                        <div class="invoice-title">
                                                    ...
                                                    <div class="invoice-detail-note">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 align-self-center">
                                                                <div class="form-group row invoice-note mb-4">
                                                                    <label for="product_category_description" class="col-sm-12 col-form-label col-form-label-sm">Kategori Aciklamasi:</label>
                                                                    <div class="col-sm-12">
                                                                        <textarea class="form-control" name="product_category_description" id="product_category_description" placeholder='Kategori Aciklamasi' style="height: 88px;"><?php echo $fetchDataProductCategoryDetails['product_category_description'] ?></textarea>
                                                                    </div>
                                                                </div>

                                                                <div class="row ">
                                                                    <div class="col-xl-12 col-md-4">
                                                                        <button type="submit" name="category_update" class="btn btn-primary btn-send">Kategori Duzenleme</button>
                                                                    </div>
                                                                </div>
