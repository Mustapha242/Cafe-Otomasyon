...
<head>
    ...
    <title>Siparişler | Asperula - Cafe Yonetim Paneli </title>
...
<body>
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        <a href="#orders" data-bs-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg width="64px" height="64px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        ...
                        <ul class="collapse submenu list-unstyled show" id="orders" data-bs-parent="#accordionExample">
                            <li class="active">
                ...
                <div class="middle-content container-xxl p-0">
                    <div class="middle-content container-xxl p-0">
                        <div class="row layout-top-spacing">
                            <?php
                            if (is_array($fetchDataOrders)) {
                                $sn = 1;
                                foreach ($fetchDataOrders as $data) {
                                    $for_other_property_table_id = $data['id'];
                                    $fetchDataOrderItems = fetch_data_order_items($db, $tableNameOrderItems, $columnsOrderItems, $for_other_property_table_id);
                            ?>
                                        ...
                                        <div class="widget widget-wallet-one">
                                            <div class="wallet-info text-center mb-3">
                                                <p class="wallet-title mb-3">
                                                    Masa Numarasi:
                                                    <?php
                                                    if ($data['customer_desk_number'] == NULL) {
                                                        echo "Null";
                                                    } else {
                                                        echo $data['customer_desk_number'];
                                                    }
                                                    ?>
                                                </p>
                                            ...
                                            <div class="wallet-action text-center d-flex justify-content-around">
                                                <a class="btn btn-info" href="app-orders.php?deactiveOrders=<?php echo $data['id']; ?>">
                                                    <svg width="24px" height="24px" viewBox="0 0 1024 1024" fill="currentColor" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                        <g id="SVGRepo_iconCarrier">
                                                    ...
                                                    <span class="btn-text-inner">Deaktif</span>
                                                </a>
                                            </div>
                                            <hr>
                                                ...
                                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                                                    <div class="widget widget-table-one">
                                                        <div class="widget-heading">
                                                            <h5 class="">Siparişler</h5>
                                                            <div class="task-action">
                                                            </div>
                                                        </div>

                                                        <div class="widget-content">
                                                            <?php foreach ($fetchDataOrderItems as $product) : ?>
                                                                ...
                                                                <div class="transactions-list t-info">
                                                                    <div class="t-item">
                                                                        <div class="t-company-name">
                                                                            <div class="t-icon">
                                                                                <div class="avatar">
                                                                                    <span class="avatar-title">ASP</span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="t-name">
                                                                                <h4><?php echo $product['product_name'] ?></h4>
                                                                                <p class="meta-date">Adet: <?php echo $product['quantity'] ?></p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="t-rate rate-inc">
                                                                            <p><span><?php echo $total_price = $product['quantity'] * $product['price'] ?> ₺</span></p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            <?php endforeach; ?>
    ...
    <script src="../src/assets/js/apps/patient-list.js"></script>
