...
<head>
    ...
    <title>Urun Listesi | Asperula - Cafe Yonetim Paneli </title>
...
<body>
                                ...
                                <table id="invoice-list" class="table dt-table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Urun O. Fiyati</th>
                                            <th>Urun B. Fiyati</th>
                                            <th>Urun Aktiflik D.</th>
                                            <th>Urun Yuk. Tarihi</th>
                                            <th>Aksiyonlar</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a href="#"><span class="inv-number"><?php echo $data['product_id'] ?></span></a></td>
                                                    <td><a href="#"><span class="inv-number">#<?php echo $data['product_category_id'] ?></span></a></td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="usr-img-frame me-2 rounded-circle">
                                                                <img alt="avatar" class="img-fluid rounded-circle" src="../<?php echo $data['product_photos_1024x683'] ?>">
                                                            </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        if (isset($data['product_small_price'])) {
                                                            if ($data['product_small_price'] != null) {
                                                                echo '<span class="badge badge-light-success inv-status">' . $data['product_small_price'] . ' ₺</span>';
                                                            } else {
                                                    ...
                                                    <td>
                                                        ...
                                                        if (isset($data['product_middle_price'])) {
                                                            if ($data['product_middle_price'] != null) {
                                                                echo '<span class="badge badge-light-success inv-status">' . $data['product_middle_price'] . ' ₺</span>';
                                                            } else {
                                                                echo '<span class="badge badge-light-danger inv-status">Bulunamadi</span>';
                                                            }
                                                        }
                                                    ...
                                                    <td>
                                                        ...
                                                        if (isset($data['product_big_price'])) {
                                                            if ($data['product_big_price'] != null) {
                                                                echo '<span class="badge badge-light-success inv-status">' . $data['product_big_price'] . ' ₺</span>';
                                                            } else {
                                                                echo '<span class="badge badge-light-danger inv-status">Bulunamadi</span>';
                                                            }
                                                        }
                                                    ...
                                                    <td><span class="inv-date"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar">
                                                            ...
                                                            </svg> <?php echo $data['product_date_time'] ?> </span></td>
                                                    <td>
                                                        ...
                                                        <a class="badge badge-light-danger text-start action-delete" href="app-product-list.php?deleteProduct=<?php echo $data['product_id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash">
    ...
    <script src="../src/assets/js/apps/product.js"></script>
</body>
