...
<head>
    ...
    <title>Rezervasyonlar | Asperula - Cafe Yonetim Paneli </title>
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        <a href="#reservation" data-bs-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        ...
                        <ul class="collapse submenu list-unstyled show" id="reservation" data-bs-parent="#accordionExample">
                            <li class="active">
                ...
                <div class="middle-content container-xxl p-0">
                    <div class="middle-content container-xxl p-0">
                        <div class="row layout-top-spacing">
                            <?php
                            if (is_array($fetchDataReservation)) {
                                $sn = 1;
                                foreach ($fetchDataReservation as $data) {
                            ?>
                                            ...
                                            <div class="widget-content">
                                                ...
                                                <div class="media">
                                                    <div class="media-body">
                                                        <h6><?php echo $data['reservation_name'] ?></h6>
                                                        <p class="meta-date-time"><?php echo ($data['reservation_clock'] . " " .  $data['reservation_date']) ?></p>
                                                    </div>
                                                </div>

                                                <div class="card-bottom-section">
                                                    <h5><?php echo $data['number_of_people'] ?> Kişilik</h5>
                                                    <a href="tel:<?php echo cleanPhoneNumber($data['reservation_phone']) ?>" class="btn"><?php echo $data['reservation_phone'] ?></a>
                                                    <a href="mailto:<?php echo $data['reservation_email'] ?>" class="btn"><?php echo $data['reservation_email'] ?></a>
                                                    <a href="app-reservation.php?deleteReservation=<?php echo $data['reservation_id']; ?>" class="btn btn-info d-flex justify-content-center">Rezervasyon Iptali</a>
                                                </div>
