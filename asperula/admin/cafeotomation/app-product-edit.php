...
<head>
    ...
    <title><?php echo $fetchDataProductDetails['product_name'] ?> Urunu Duzenleme | Asperula - Cafe Yonetim Paneli </title>
                                                ...
                                                <div class="invoice-detail-body">
                                                    ...
                                                    <div class="invoice-detail-title">
                                                        ...
                                                        <div class="invoice-title">
                                                            <input type="text" name="product_name" class="form-control" placeholder="Urun Adi" value="<?php echo $fetchDataProductDetails['product_name'] ?>">
                                                        ...
                                                        <div class="row justify-content-between">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-sm" name="product_small_price" id="product_small_price" value="<?php echo $fetchDataProductDetails['product_small_price'] ?>">
                                                                </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-sm" name="product_middle_price" id="product_middle_price" value="<?php echo $fetchDataProductDetails['product_middle_price'] ?>">
                                                                </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-sm" name="product_big_price" id="product_big_price" value="<?php echo $fetchDataProductDetails['product_big_price'] ?>">
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group row invoice-created-by">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <img class="form-control file-upload-input" src="../<?php echo $fetchDataProductDetails['product_photos_1024x683'] ?>" alt="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="form-group row invoice-created-by">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-check form-check-primary form-check-inline">
                                                                            <input class="form-check-input" type="checkbox" id="product_publicy" name="product_publicy" <?php echo ($fetchDataProductDetails['product_publicy'] == '1') ? 'checked' : ''; ?>>
                                                ...
                                                <div class="invoice-action-btn">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-12 col-md-4">
                                                            <button type="submit" name="product_update" class="btn btn-primary btn-send">Urun Guncelle</button>
                                                        </div>
                                                    </div>
                                                </div>
